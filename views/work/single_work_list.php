           ...
           <nav class="navbar navbar-default">
            <div class="container-fluid">
              <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#">Single Work Details</a>
              </div>
              <div class="collapse navbar-collapse" id="myNavbar">
                <ul class="nav navbar-nav navbar-right">
                  <li>
                    <a href="<?php $this->url('work', 'work_files', "&w_id=".$work['w_id']);?>">
                      <i class="fas fa-folder-open"></i> See Files
                    </a>
                  </li>
                  <li>
                    <a href="<?php $this->url('work', 'edit_work_files', "&w_id=".$work['w_id']);?>">
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="panel panel-primary">
              <div class="panel-heading">Work Title: <?= $work['work_title'].$work['project_name']?></div>
                ...
                <div class="row">
                  ...
                  <div class="col-md-8 col-md-offset-2" style="border: 1px solid #337AB7;padding: 20px 0 0;box-shadow: 0px 0px 2px 1px #ececec;border-radius:10px;color: #000;">
                    ...
                    <table class="table table-bordered" style="font-size: 14px; font-family: 'Arial Black'; margin-bottom: 0">
                      ...
                      <tr>
                        <th class="bg-navy">Work Title</th>
                        <td class="bg-gray"><?= $work['work_title']?></td>
                      </tr>

                      <tr>
                        <th class="bg-navy">Description</th>
                        <td class="bg-gray"><?= $work['work_description']?></td>
                      </tr>

                      <tr>
                        <th class="bg-navy">Count</th>
                        <td class="bg-gray"><?= $work['count']?></td>
                      </tr>

                      <tr>
                        <th class="bg-navy">Assigned By</th>
                        <td class="bg-gray"><?= $this->empName($work['assigned_by']);?></td>
                      </tr>

                      <tr>
                        <th class="bg-navy">Rating</th>
                        <td class="bg-gray"><?= $work['rating']?>/10</td>
                      </tr>  

                      <tr>
                        <th class="bg-navy">Start Date</th>
                        <td class="bg-gray"><?= $this->date($work['start_date'],'d F, Y');?></td>
                      </tr>

                      <tr class="">
                        <th class="bg-navy" style="border-radius:0 0 0 10px;">End Date</th>
                        <td class="bg-gray" style="border-radius:0 0 10px 0;"><?=  $this->date($work['end_date'], 'd F, Y')?></td>
                      </tr>
...
<div class="chat-popup" id="chat_box">
  <div class="chat-header bg bg-primary">
    ...
    <h5 >Chat about <b><?= $work['work_title'].' - '.$work['project_name']?></b></h5>
  </div>
  <div class="chat-body">
